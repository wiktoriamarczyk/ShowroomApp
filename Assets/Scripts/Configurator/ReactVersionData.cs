...
public class ReactVersionData : ScriptableObject {
    public static readonly string description = Common.descriptions[Common.eVersion.REACT];

    public readonly static IReadOnlyList<string> drives = new[] {
        Common.drives[Common.eDrive.T3_MANUAL],
        Common.drives[Common.eDrive.T3_AUTOMATIC],
    };

    public readonly static IReadOnlyList<string> packages = new[] {
    ...
    public readonly static IReadOnlyDictionary<string, string> colorsData = new Dictionary<string, string>() {
    ...
    public readonly static IReadOnlyDictionary<string, string> rimsData = new Dictionary<string, string>() {
